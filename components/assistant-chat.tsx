    ...
    <div className="h-full p-6">
      <Card className="h-full p-6 flex flex-col">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">{activeAssistant?.description}</p>
        </div>
        ...
        <div className="border rounded-lg divide-y">
          {[1, 2, 3].map((item) => (
            <div key={item} className="p-4 flex items-start">
              ...
              <div>
                <p className="font-medium">Novo preço identificado</p>
                <p className="text-sm text-gray-500">Alerta de variação de preço às 14:32</p>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[13, 14, 16].map((item) => (
                <tr key={item}>
                  <td className="px-6 py-4 whitespace-nowrap">Produto - 195/55R{item}</td>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-lg">
            ...
            <div className="flex items-center text-sm text-gray-500">
              ...
              <span>Concluída em 04/06/2025 às 14:32</span>
            </div>
            <div className="mt-3">
              <Button>
